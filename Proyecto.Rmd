...
```
No hay una correlación fuerte entre estos rendimientos; de manera significativa, solo en el lag 3 y 8 se sale de las bandas de confianza tanto del ACF como del PACF de manera significativa. Proponemos un ARMA(2,2) para modelar esta parte, aunque intentaremos también
con un AR(2). 
