...
na_kalman_auto.arima=auto.arima(Serie_2,option='auto.arima')[29]-Original[1]
na_kalman_auto.arima[2:3]=auto.arima(Serie_2,option='auto.arima')[38:39]-Original[2:3]
...
na_kalman_StructTS=na_interpolation(Serie_2,option='StructTS')[29]-Original[1]
na_kalman_StructTS[2:3]=na_interpolation(Serie_2,option='StructTS')[38:39]-Original[2:3]
...
na_locf=na_interpolation(Serie_2,option='locf')[29]-Original[1]
na_locf[2:3]=na_interpolation(Serie_2,option='locf')[38:39]-Original[2:3]
...
na_locf_nocb=na_interpolation(Serie_2,option='nocb')[29]-Original[1]
na_locf_nocb[2:3]=na_interpolation(Serie_2,option='nocb')[38:39]-Original[2:3]
...
na_ma_simple=na_interpolation(Serie_2,option='simple')[29]-Original[1]
na_ma_simple[2:3]=na_interpolation(Serie_2,option='simple')[38:39]-Original[2:3]
