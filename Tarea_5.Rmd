...
cens <- tabla_aux[,1]
fallas <- tabla_aux[,2]
Tabla_Vida_Actuarial<- lifetab(tis = intEndpts, ninit=ntotal, nlost=cens, nevent=fallas)
...
plot(x, y, type="l", col="darkred", xlab="Time", ylab="Supervivencia (Life Table)", 
...
plot(x, y, type="l", col="darkgreen", xlab="Time", ylab="Riesgo (Life Table)",
     col.lab="darkblue",lwd=2)
