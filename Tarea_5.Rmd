...
b <- barplot(Edad,col= palette(pal_lancet("lanonc")(5)),
             main="Gráfica de barras: Etapa de cáncer", col.main="red", 
             ylab="Frecuencia absoluta", col.lab="green")
text(x=b,y=c(Edad), labels=c(Edad), pos=3, col="darkgreen", cex=1.5, xpd=TRUE)
#Observaciones
Edad
#Porcentaje
Edad/.9
...
## Edad
```{r,message=FALSE}
edad<-hist(age, probability=F, col=palette(pal_lancet("lanonc")(9)), border="white", 
     main="Histograma del tiempo de supervencia",labels=TRUE,ylim=c(0,20)) 
#Puntos de corte
edad$breaks
#Cantidad
edad$counts
...
b <- barplot(year,col= palette(pal_lancet("lanonc")(5)),
             main="Gráfica de barras: Etapa de cáncer", col.main="red", 
             ylab="Frecuencia absoluta", col.lab="green",ylim=c(0,25))
text(x=b,y=c(year), labels=c(year), pos=3, col="darkgreen", cex=1.5, xpd=TRUE)
#Observaciones
year
#Porcentaje
year/.9
...
b <- barplot(fallas,col= palette(pal_lancet("lanonc")(5)),
             main="Gráfica de barras: Etapa de cáncer", col.main="red", 
             ylab="Frecuencia absoluta", col.lab="green",ylim=c(0,60))
text(x=b,y=c(fallas), labels=c(fallas), pos=3, col="darkgreen", cex=1.5, xpd=TRUE)
fallas/.9
```
...
```{r}
data.frame("t"=general_fit$time,"Expuestos"=general_fit$n.risk,"S(t)"=general_fit$surv,
           "error estándar"=general_fit$std.err, "límite superior"=general_fit$lower,
           "límite inferior"=general_fit$upper)
```
```{r}
KM(delta,time)
```
